package com.anli.busstation.dal.sql.definitions;
...
public class EntityDefinitionBuilder {
    ...
    public EntityDefinitionBuilder addNamedQuery(String name, String joins, String criteria) {
        definition.addNamedQuery(getNamedQuery(name, joins, criteria));
        return this;
    }
    ...
    protected NamedQuery getNamedQuery(String name, String additionalJoins, String criteria) {
        return new NamedQuery(name, additionalJoins, criteria);
    }
}
